  ...
  return (
    <section id="companies" className="container">
      ...
      <ul style={{ marginTop: 28, lineHeight: 1.6 }}>
        <li>
          <strong>Cumplimiento legal:</strong> bajo la Ley de Activos Digitales
          (LEAD) y estándares internacionales AML/CFT.
        </li>
        <li>
        ...
        <li>
          <strong>Ventaja competitiva:</strong> innovación, rapidez y confianza.
        </li>
      </ul>
